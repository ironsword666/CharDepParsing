...
def main():
    ...
    parser.add_argument('--orientation', choices=['leftward', 'rightward'], default='leftward', type=str, help='how to transform the word to a char dep tree')
