...
from supar import WordBasedVIConstituencyParser
...
def main():
    ...
    parser.set_defaults(Parser=WordBasedVIConstituencyParser)
    ...
    subparser.add_argument('--interpolation', default=0.1, type=float, help='loss weight for structure and label')
    # evaluate
