...
from supar import MixedSplitCoarse2FineCharCRFDependencyParser
from supar.cmds.cmd import parse


def main():
    parser = argparse.ArgumentParser(description='Create first-order CRF Dependency Parser.')
    parser.set_defaults(Parser=MixedSplitCoarse2FineCharCRFDependencyParser)
    ...
    subparser.add_argument('--shared_arc_info', default=None, choices=[None, 'repr', 'one_biaffine', 'two_biaffine'], help='whether to share information between intra and inter arc')
    ...
    subparser.add_argument('--orth_loss_weight', default=0.01, type=float, help='whether to share information between intra and inter arc')
    # evaluate
